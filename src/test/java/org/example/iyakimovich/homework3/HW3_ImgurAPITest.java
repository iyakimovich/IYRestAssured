package org.example.iyakimovich.homework3;
...
public class HW3_ImgurAPITest
{
    private static final Logger LOGGER = LoggerFactory.getLogger(HW3_ImgurAPITest.class);
